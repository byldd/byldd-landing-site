...
import { uaeProductDevelopmentForFoundersContent as content } from "@/modules/UaeProductDevelopmentForFounders/content";
...
export function UaeProductDevelopmentForFoundersPage() {
  return (
