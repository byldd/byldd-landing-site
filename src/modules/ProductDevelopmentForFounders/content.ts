...
export const productDevelopmentForFoundersContent = {
  hero: { 
    headline: "From idea to working software",
    highlightedHeadline: "in 45 days.",
    description:
      "Skip the dev hiring chaos. At Byldd, we partner with non-technical founders to build their software product end-to-end so you can launch faster with confidence.",
    stats: [
    ...
    formId: "product-development-for-founders-form",
    formIdPrefix: "product-development-for-founders-hero",
  ...
  testimonials: {
    id: "product-development-for-founders-testimonials",
  ...
  strategyCall: {
    ...
    formDescription: "",
    formIdPrefix: "product-development-for-founders-footer",
    submitLabel: "Get in touch",
  },
  faq: {
